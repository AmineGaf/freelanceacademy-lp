...
export const ABOUTUS_CONTENT = {
  title: (
    <>
      علاش الفريلانس هو فرصتك الذهبية في <span className="font-sora">2025</span>
      ؟
    </>
  ),
  sub: `الفريلانس ما عادش مجرد "خدمة إضافية" اليوم هو طريق مُثبت للحرية المالية، المرونة، و النمو الشخصي. سواء حاب تعملو كعمل جانبي أو كوظيفة كاملة، الفرص لا تنتهي`,
  cards: [
    {
      icon: <Profit />,
